...
class AccountOpenAPI(AuthenticatedClient):
    def __init__(self, auth_manager=None):
        # Create an HTTP client for your API
        self.client = AuthenticatedClient(
            base_url="https://account.api.openbridge.io",
        ...
        openapi_spec = yaml.safe_load(httpx.get("https://account.api.openbridge.io/api/schema.yaml").text)
