...
class Settings(BaseSettings):
    ...
    mcp_server_name: str = Field(
        "amazon-ads-api", description="MCP Server Name"
    )
    ...
    log_level: Literal["DEBUG", "INFO", "WARNING", "ERROR", "CRITICAL"] = (
        Field("INFO", description="Logging level")
    )
    ...
    def effective_refresh_token(self) -> Optional[str]:
        ...
        :rtype: Optional[str]
        """
        return self.ad_api_refresh_token or self.amazon_ads_refresh_token
    ...
    def region_endpoint(self) -> str:
        ...
        base = region_map.get(self.amazon_ads_region, region_map["na"])
